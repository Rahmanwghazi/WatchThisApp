...
var reviewSeriesList = [
  ReviewSeries(
      ...
      language: 'Thai',
      synopsis:
          'A mysterious, clever girl named Nanno transfers to different schools, exposing the lies and misdeeds of the students and faculty at every turn. This time, she returned to expose the lies and hypocrisy that occurred at the high school where he attended school. Not only that, Nanno also came to deal directly with the students who had been the source of problems at his school.',
      stars:
          'Chicha Amatayakul, James Teeradon, Tai Penpak Sirikul, Paricia Tancanok, Nink',
